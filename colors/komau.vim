...
call s:h("DiagnosticError", {"gui": "bold", "fg": s:red})
call s:h("DiagnosticWarn",  {"gui": "bold", "fg": s:yellow})
call s:h("DiagnosticInfo",  {"gui": "bold", "fg": s:blue})
call s:h("DiagnosticHint",  {"gui": "bold", "fg": s:norm_subtle})

call s:h("DiagnosticUnderlineError", {"fg": s:red, "gui": "undercurl", "cterm": "underline"})
call s:h("DiagnosticUnderlineWarn",  {"fg": s:yellow, "gui": "undercurl", "cterm": "underline"})
call s:h("DiagnosticUnderlineInfo",  {"fg": s:blue, "gui": "undercurl", "cterm": "underline"})
call s:h("DiagnosticUnderlineHint",  {"fg": s:norm_subtle, "gui": "undercurl", "cterm": "underline"})
