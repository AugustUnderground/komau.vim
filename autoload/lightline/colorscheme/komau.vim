...
if s:isDark
    ...
    let s:p.insert.left   = [[["#09814a", 235], ["#303030", 167]], [["#F0F0F0", 167], ["#222222", 235]]]
    let s:p.insert.middle = [[["#F0F0F0", 255], ["#181818", 235]]]
    let s:p.insert.right  = [[["#09814a", 235], ["#303030", 167]], [["#F0F0F0", 167], ["#222222", 235]]]

    let s:p.replace.left   = [[["#303030", 235], ["#09814a", 167]], [["#F0F0F0", 167], ["#222222", 235]]]
    let s:p.replace.middle = [[["#F0F0F0", 255], ["#181818", 235]]]
    let s:p.replace.right  = [[["#303030", 235], ["#09814a", 167]], [["#F0F0F0", 167], ["#222222", 235]]]
    ...
    let s:p.insert.left   = [[["#09814a", 235], ["#303030", 167]], [["#131313", 167], ["#999999", 235]]]
    let s:p.insert.middle = [[["#131313", 255], ["#F5F5F5", 235]]]
    let s:p.insert.right  = [[["#09814a", 235], ["#303030", 167]], [["#131313", 167], ["#999999", 235]]]

    let s:p.replace.left   = [[["#303030", 235], ["#09814a", 167]], [["#131313", 167], ["#999999", 235]]]
    let s:p.replace.middle = [[["#131313", 255], ["#F5F5F5", 235]]]
    let s:p.replace.right  = [[["#303030", 235], ["#09814a", 167]], [["#131313", 167], ["#999999", 235]]]
